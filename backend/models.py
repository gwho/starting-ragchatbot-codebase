...
class Source(BaseModel):
    """Represents a clickable source citation"""
    text: str                           # Display text: "Course - Lesson 5"
    link: Optional[str] = None          # URL to course/lesson page
    type: str = "lesson"                # "lesson" or "course"